...
**Một ứng dụng "12 Yếu Tố" không bao giờ phụ thuộc vào sự hiện diện tuyệt đối của các gói hệ
...
Các ứng dụng "12 Yếu Tố" đông thời có thể không phụ thuộc vào bất cứ sự hiện diện của các công cụ hệ thống tuyệt đối nào. Các ví dụ bao gồm các công cụ cài đặt sẵn như ImageMagick hay `curl`. Trong khi các công cụ trên có thể hiện diện trên đa số các hệ thống, nhưng không có gì bảo
